...
def result1(rank, course_requirement, weights):
    ...
    file_path_subjects = 'D:\期中实训\interm_practice\code\your_gaokao_helper\code\info\data.csv'
    ...
    file_path_holland = 'D:\期中实训\interm_practice\code\your_gaokao_helper\code\info\data_subject_holland.csv'
    ...
    file_path_cluster = 'D:\期中实训\interm_practice\code\your_gaokao_helper\code\info\cluster_results.csv'
